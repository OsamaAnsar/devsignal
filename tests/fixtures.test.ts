import { describe, expect, it } from "vitest"; import { parseGitHubTrending, parseHackerNews, parseRedditListing } from "../scripts/scrape";
describe("scrapers",()=>{
  ...
  it("parses Reddit OAuth listings",()=>{const listing={data:{children:[{data:{id:"abc",title:"New JavaScript framework",permalink:"/r/webdev/abc",score:40,num_comments:5,subreddit:"webdev"}}]}};expect(parseRedditListing(listing)[0]).toMatchObject({id:"reddit-abc",source:"Reddit",score:45,metric:"engagement"})});
});
