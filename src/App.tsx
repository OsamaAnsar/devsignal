...
const aiCacheFromStorage = () => { try { return JSON.parse(localStorage.getItem("devsignal-ai-cache") ?? "null") as { generatedAt: string; signals: Signal[] } | null; } catch { return null; } };
...
export default function App() {
  ...
  const runLocalAi = async (targets: Signal[]) => {
    ...
    try {
      ...
      setLocalSignals(nextSignals); if (data) localStorage.setItem("devsignal-ai-cache", JSON.stringify({ generatedAt: data.generatedAt, signals: nextSignals }));
