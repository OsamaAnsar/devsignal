...
export const sourceLabel = (source: Source) => ({ "Hacker News": "HN", "GitHub Trending": "GH", Reddit: "RD", "npm Registry": "NPM", "DEV Community": "DEV", Lobsters: "LOB", X: "X", arXiv: "ARX", "Stack Overflow": "SO", InfoQ: "IQ" })[source];
